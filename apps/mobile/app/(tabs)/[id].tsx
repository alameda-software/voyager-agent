...
const styles = StyleSheet.create({
  ...
  messagesContainer: { flex: 1, backgroundColor: "#f8fafc", width: '100%' },
  messagesList: { padding: 12, paddingBottom: 8, backgroundColor: "#f8fafc", width: '100%' },
  stateCard: { display: 'none' },
  stateTitle: { display: 'none' },
  stateBody: { display: 'none' },
  messageContainer: { marginBottom: 8, maxWidth: '100%', paddingHorizontal: 2 },
