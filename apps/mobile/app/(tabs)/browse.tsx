...
const styles = StyleSheet.create({
  ...
  safeTop: { height: 50, backgroundColor: '#f8fafc' },
  hero: { width: '100%', height: 200, position: 'relative' },
  heroImage: { width: '100%', height: 200 },
  heroOverlay: { position: 'absolute', bottom: 0, left: 0, right: 0, paddingBottom: 16, paddingHorizontal: 16, paddingTop: 40, backgroundColor: 'rgba(0,0,0,0.38)' },
